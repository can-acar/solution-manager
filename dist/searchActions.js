...
exports.openScopedFindInFiles = openScopedFindInFiles;
exports.openScopedQuickOpen = openScopedQuickOpen;
const vscode = __importStar(require("vscode"));
function toSearchScope(folderPath) {
...
async function openScopedFindInFiles(folderPath, replace) {
    const args = {
