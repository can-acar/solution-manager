...
function activate(context) {
  ...
  context.subscriptions.push(
    ...
    vscode.commands.registerCommand('solutionManager.solutionSelectRunProfile', (node) => provider.runSolutionAction('selectRunProfile', node)),
    vscode.commands.registerCommand('solutionManager.solutionRun', (node) => provider.runSolutionAction('runProfile', node)),
    vscode.commands.registerCommand('solutionManager.solutionDebug', (node) => provider.runSolutionAction('debugProfile', node)),
