...
type SolutionFileEditOptions = {
  createGuid?: () => string;
  name?: string;
  solutionFolder?: string;
};

async function addProjectToSolutionFile(solutionPath: string, projectPath: string, options: SolutionFileEditOptions = {}) {
...
async function addSolutionFolderToSolutionFile(solutionPath: string, folderPath: string, options: SolutionFileEditOptions = {}) {
  const text = await readTextFile(solutionPath);
...
async function saveSolutionAs(sourcePath: string, targetPath: string) {
  const text = await readTextFile(sourcePath);
  await writeTextFile(targetPath, text);
}

function addProjectToSolutionText(text: string, solutionPath: string, projectPath: string, options: SolutionFileEditOptions = {}) {
...
function addSolutionFolderToSolutionText(text: string, solutionPath: string, folderPath: string, options: SolutionFileEditOptions = {}) {
  const extension = path.extname(solutionPath).toLowerCase();
...
function addProjectToSlnText(text: string, solutionPath: string, projectPath: string, options: SolutionFileEditOptions = {}) {
...
function addProjectToSlnxText(text: string, solutionPath: string, projectPath: string, options: SolutionFileEditOptions = {}) {
